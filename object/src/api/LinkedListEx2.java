...
public class LinkedListEx2 {
    ...
    static long add1(List<String> list) {
        // currentTimeMillis() : millisecond 시간 재서 for문 동안 작업속도 카운트
