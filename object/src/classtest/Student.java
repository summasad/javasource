...
public class Student {
    ...
    // 생성자의 목적은 인스턴스 초기화 매소드
    // 생성자 오버로딩

    private String hakbun; // 학번 s1357486
    private String name; // 이름 홍길동
    private String address; // 주소 서울시 종로구
    private String mobile; // 핸드폰 010-6546-3213
    ...
    // Student(String hakbun, String name, String address){
    // this.hakbun = hakbun;
    // this.name = name;
    // this.address = address;
    // }

    // Student(String hakbun, String name, String address, String mobile){
    // this.hakbun = hakbun;
    // this.name = name;
    // this.address = address;
    // this.mobile = mobile;
